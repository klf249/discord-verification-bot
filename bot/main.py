...
# Ajouter le chemin parent pour les imports (important AVANT d'importer database)
# __file__ est bot/main.py -> parent = bot/, parent.parent = repo root
...
# Maintenant on peut importer des modules situés à la racine du repo
